...
**GHCR:** `docker pull ghcr.io/stighellemans/meddeid-annotate:0.3.0`
...
**GHCR:** `docker pull ghcr.io/stighellemans/meddeid-curate:0.3.0`
...
**GHCR:** `docker pull ghcr.io/stighellemans/meddeid-subannotate:0.3.0`
