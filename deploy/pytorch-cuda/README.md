...
For release `0.4.2`, the candidate tag is
`ghcr.io/stighellemans/meddeid-api:0.4.2-cuda12.9`. Production deployments
...
```bash
./deploy/build_pytorch_cuda_image.sh meddeid-api:0.4.2-cuda12.9-test
./deploy/validate_pytorch_cuda_image.sh meddeid-api:0.4.2-cuda12.9-test
```
